...
The evaluation order of control flows issuing from a decision node is the order in which they were added to the procedure during the procedure configuration process.
If the guards of two or more such control flows evaluate to TRUE, the first control flow in this order is selected.
...
The evaluation order of transitions with the same source is the order in which they were added to the state machine during the state machine configuration process. If the guards of two or more such transitions evaluate to TRUE, the first transition in this order is selected.
