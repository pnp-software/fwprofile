...
%----------------------------------------------------------------------------
{It shall be possible to read the current state of a state machine and, if available, its previous state.}
%-----------------------------------------------------------------------------
{Applications need to be able to check the current state of a state machine and, if available, its previous state.}
%-----------------------------------------------------------------------------
{Read-only access to the current state of a state machine is provided by function \texttt{FwSmGetCurState}, for the previous state the read-only access function is \texttt{FwSmGetPrevState}. 
Function \texttt{FwSmIsStarted} checks whether a state machine has been started.} 
%-----------------------------------------------------------------------------
{Functions \texttt{FwSmGetCurState} and \texttt{FwSmGetPrevState} are used in virtually all
...
\texttt{FwPrGetCurNode}, for the previous node the read-only access function is \texttt{FwPrGetPrevNode}.
Function \texttt{FwPrIsStarted} checks whether a procedure has been started.} 
%-----------------------------------------------------------------------------
{Functions \texttt{FwPrGetCurNode} and \texttt{FwPrGetPrevNode} are used in virtually all Test Cases of
the Test Suite. 
