...
%-----------------------------------------------------------------------------
{Read-only access to the previous state of a state machine is provided 
by function \texttt{FwSmGetPrevState}, for current state the read-only access function is \texttt{FwSmGetCurState}. 
Function \texttt{FwSmIsStarted} checks whether a state machine has been started.}
%-----------------------------------------------------------------------------
{Function \texttt{FwSmGetPrevState} and \texttt{FwSmGetCurState} are used in virtually all
